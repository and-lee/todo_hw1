...
class TodoListView {
    ...
    buildListItem(listItem, listItemIndex) {
        ...
        del.innerHTML = "&#10005"; // MULTIPLICATION SYMBOL AS CROSS
        this.setupCallback(del, TodoHTML.ONCLICK, TodoCallback.PROCESS_DELETE_ITEM, itemArgs);

        toolbarDiv.appendChild(up);
        toolbarDiv.appendChild(down);
    ...
    /**
     * Button on the bottom of the list that when pressed, 
     * brings the user to an item edit screen where they enter information about a new item.
     */
    ...
    loadItems(listToLoad) {
        ...
        // load footer
        let listItemsFooterDiv = this.buildListItemsFooter();
        listItemsDiv.appendChild(listItemsFooterDiv);
