...
class TodoListModel {
    ...
    goList() {
        ...
        // THIS MIGHT HAVE OCCURED FROM ITEM SO HIDE ITEM
        this.view.showElementWithId(TodoGUIId.TODO_ITEM, false); //************ */
    ...
    compare(item1, item2) {
        ...
        // SORT BY DUE DATE
        if(thisModel.isCurrentItemSortCriteria(ItemSortCriteria.SORT_BY_DUE_DATE_INCREASING)
            || thisModel.isCurrentItemSortCriteria(ItemSortCriteria.SORT_BY_DUE_DATE_DECREASING)) {
